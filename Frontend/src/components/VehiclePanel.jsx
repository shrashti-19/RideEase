    ...
    return (
        <div>
            ...
            <div
                ...
                className="flex border-2 focus:ring-2 focus:ring-black hover:border-black mb-2 rounded-xl w-full items-center justify-between p-3 cursor-pointer transition-all">
                <img className="h-12" src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,h_552,w_552/v1555367310/assets/30/51e602-10bb-4e65-b122-e394d80a9c47/original/Final_UberX.png" alt="Uber Go"/>
            ...
            <div
                ...
                className="flex border-2 focus:ring-2 focus:ring-black hover:border-black mb-2 rounded-xl w-full items-center justify-between p-3 cursor-pointer transition-all">
                <img className="h-12" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTsFabRnJZ8deGXJSKA1QjN45920WytRrdFsA&s" alt="Uber Auto"/>
                <div className="ml-2 w-1/2">
